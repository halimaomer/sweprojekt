...
from hotel.banner import banner
from hotel.config import (
    dev_db_populate,
    dev_keycloak_populate,
)
from hotel.config.dev.db_populate import db_populate
from hotel.config.dev.db_populate_router import router as db_populate_router
from hotel.config.dev.keycloak_populate import keycloak_populate
...
from hotel.security import AuthorizationError, LoginError, set_response_headers
from hotel.security import router as auth_router
...
# R E S T
# --------------------------------------------------------------------------------------
app.include_router(hotel_router, prefix="/rest")
app.include_router(hotel_write_router, prefix="/rest")
