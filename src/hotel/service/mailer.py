...
def send_mail(hotel_dto: HotelDTO) -> None:
    """Funktion, um eine E-Mail zu senden.

    :param hotel_dto: Hotel-Daten
    """
    ...
    # Body und Subject
    msg: Final = MIMEText(f"Neues Hotel: <b>{hotel_dto.name}</b>")
    msg["Subject"] = f"Neues Hotel: ID={hotel_dto.id}"
